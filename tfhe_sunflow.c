...
struct TGswParams*  TGswParams_init(int32_t l, int32_t Bgbit, const struct TLweParams* tlwe_params) {
...
{   //we need note the  current ptr
    ...
    TGswParams *params_bk = TGswParams_init(bk_l, bk_Bgbit, params_accum);
